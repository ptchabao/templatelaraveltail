    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'icon' => 'dock_to_right',
                'sub_items' => [
                    ['name' => 'Dark Mode', 'url' => 'https://trezo-twcss-dark.envytheme.com/', 'target' => '_blank'],
                    ['name' => 'Sidebar Dark', 'url' => 'https://trezo-dls.envytheme.com/', 'target' => '_blank'],
                    ['name' => 'RTL Light', 'url' => 'https://trezo-twcss-rtl.envytheme.com/index.html', 'target' => '_blank'],
                    ['name' => 'RTL Dark', 'url' => 'https://trezo-twcss-dark-rtl.envytheme.com/index.html', 'target' => '_blank'],
                ]
            ],
            [
                'type' => 'accordion',
